...
<p>In the JavaScript SDK, you need to import this package first.</p>

```bash [Bash]
npm i @xmtp/content-type-transaction-reference
```

<p>After importing the package, you can register the codec.</p>
...
<p>Once you have a transaction reference, you can send it as part of your conversation:</p>
