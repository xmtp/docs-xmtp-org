...
:::tip[Best practice: Set enableV3 to true]

Regardless of whether your app provides group chat, set the `enableV3` client option to `true` to benefit from other aspects of the upgraded XMTP v3 protocol. Enabling v3 is additive and does not stop support for XMTP v2 functionality.
