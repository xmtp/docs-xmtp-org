...
Regardless of whether your mobile app provides group chat, set the `enableV3` client option to `true` to benefit from other aspects of the upgraded XMTP v3 protocol. Enabling v3 is additive and doesn't stop your app's support for XMTP v2 functionality.
...
let client = try await Client.create(
    ...
    options: .init(
        ...
        enableV3: true, // Enable group chat support
        dbDirectory: "mydir", // Optional: specify database directory
...
<table>
  ...
  <tr>
    <td>enableV3</td>
    <td>`false`</td>
    <td>To support group chat (a feature of XMTP v3), set to `true`. As a best practice, regardless of whether your app provides group chat, set `enableV3` to `true` to benefit from other aspects of the upgraded XMTP v3 protocol.</td>
  </tr>
  <tr>
    <td>appContext</td>
    <td>null</td>
    ...
    <tr>
      <td>dbDirectory</td>
      <td>xmtp_db</td>
      <td>Optional. Specify a database directory.</td>
    </tr>
  <tr>
    <td>dbEncryptionKey</td>
    <td>null</td>
    <td>Required. For information about recommended key storage for Kotlin, [Android Keystore system](https://developer.android.com/privacy-and-security/keystore).</td>
  </tr>
  <tr>
    <td>appVersion</td>
    <td>`undefined`</td>
...
<table>
  ...
  <tr>
    ...
    <td>dbEncryptionKey</td>
    <td>null</td>
    <td>Required. For information about recommended key storage for Swift, see [Protecting keys with the Secure Enclave](https://developer.apple.com/documentation/security/protecting-keys-with-the-secure-enclave).</td>
  </tr>
  <tr>
    <td>appVersion</td>
    <td>`undefined`</td>
...
<div data-title="React Native">
  <table>
    ...
    <tr>
      <td>dbEncryptionKey</td>
      <td>null</td>
      <td>Required. For information about recommended key storage for Kotlin, [Android Keystore system](https://developer.android.com/privacy-and-security/keystore). For information about recommended key storage for Swift, see [Protecting keys with the Secure Enclave](https://developer.apple.com/documentation/security/protecting-keys-with-the-secure-enclave).</td>
    </tr>
        <tr>
      <td>appVersion</td>
      <td>`undefined`</td>
