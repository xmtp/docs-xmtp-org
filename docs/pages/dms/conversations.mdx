...
- Be sure to provide error messaging when a user enters an address in the **To** field and the address hasn't yet created an XMTP identity.
  ...
  <div>
  <img src="https://raw.githubusercontent.com/xmtp/docs-xmtp-org/main/docs/pages/img/no-xmtp-identity.png" width="500" />
  </div>

## Start a new conversation

You can create a new conversation with any address activated on the XMTP network. To learn more about supported addresses, see [Chains](/get-started/faq#chains).
...
These conversations include all conversations for a user **regardless of which app created the conversation.** This functionality provides the concept of an [interoperable inbox](/protocol/portable-inbox), which enables a user to access all of their conversations in any app built with XMTP.
