...
## Sync all new conversations and messages

Sync all new conversations and messages from the network.
...
This video provides a walkthrough of syncing, covering the key ideas discussed in this doc.
