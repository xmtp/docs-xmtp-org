...
The super admin has all of the [available permissions](https://www.notion.so/Updates-to-group-permissions-docs-15030823ce92805481f4d8915e7dd693?pvs=21) and can use them to adjust the group’s permissions and options.
