...
## Sync all new conversations, messages, and preferences

Sync all new group chat and DM conversations, messages, and [preference updates](/inboxes/sync-preferences).

To sync preferences only, you can call [preferences.sync](/inboxes/sync-preferences). Note that sync preferences will also sync welcomes to ensure that you have all potential new installations before syncing.
