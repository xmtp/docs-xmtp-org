...
Sync all new group chat and DM conversations, messages, and installation-related [sync group](/inboxes/history-sync#sync-group) updates (consent states, HMAC keys, etc.) from the network. We recommend that you run this sync in the background and call it more frequently than not.
