...
To sync preferences only, you can call [preferences.sync](/inboxes/sync-preferences). Note sync preferences will also sync welcomes to make sure you have all potential new installations before syncing.
