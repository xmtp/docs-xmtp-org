...
An identity can have up to 25 app installations before it needs to [revoke an installation](#revoke-an-installation).
...
You can revoke a specific installation other than the currently accessed installation.
