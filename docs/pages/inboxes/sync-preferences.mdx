...
- HMAC keys (for [push notifications](/inboxes/push-notifs/understand-push-notifs))
...
Use this call to sync preferences (consent preferences and HMAC keys) across app installations in a preferences group. 
