...
To learn more, see [Understand how user consent preferences enable spam-free inboxes](/inboxes/support-consent).
...
## How uesr consent preferences work
...
You can implement [user consent preferences](/inboxes/support-consent) to give your users inboxes that are **spam-free spaces for allowed contacts only**.
