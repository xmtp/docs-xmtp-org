...
For Browser SDK (v6.0.0+) and Node SDK (v5.0.0+), the transaction reference content type is built-in and does not require separate installation or codec registration.
