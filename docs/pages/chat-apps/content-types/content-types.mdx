...
- Deleted message content type: Used internally by the SDK to represent deleted or expired disappearing messages. This content type is automatically handled when messages are deleted.
