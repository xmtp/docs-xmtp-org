...
- [Markdown content type](/chat-apps/content-types/markdown): Use to send rich formatted text messages with headers, lists, code blocks, and other markdown formatting elements.
