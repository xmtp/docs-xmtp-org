...
// 6. Access conversation topics for advanced use cases
// Get the welcome topic for subscribing to new conversation invitations
console.log('Welcome topic:', client.conversations.topic);

// Get a specific conversation's topic for subscribing to its messages
console.log('Conversation topic:', group.topic);
```
