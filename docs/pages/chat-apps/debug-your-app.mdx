...
### Multi-process logging (Android)

For Android apps with notification extensions or other background services, you can now enable separate log files for each process type. This prevents log file conflicts and makes it easier to debug issues in notification services.
