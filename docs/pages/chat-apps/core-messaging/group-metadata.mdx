...
- `app_data`: Custom application-specific data for the group chat
...
App data is custom application-specific data that can be stored with a group. This allows your app to store additional metadata or settings for groups.
