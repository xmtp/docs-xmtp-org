...
Update the custom application-specific data for a group. The data is stored as a string (max 8192 bytes), so you'll need to serialize any objects (e.g., using JSON.stringify).
