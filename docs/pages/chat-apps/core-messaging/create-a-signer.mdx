...
## Add and test a custom chain

To test a blockchain that is not part of the supported chain list, check out [libxmtp](https://github.com/xmtp/libxmtp/) locally and add it for testing:
