...
If you want to test XMTP with a Blockchain that isn't in our list of supported chains, you can do the following:

1. Clone https://github.com/xmtp/libxmtp
2. Add your RPC urls (like in this PR https://github.com/xmtp/libxmtp/pull/3021/changes)
3. Run the local backend
4. Test your signatur or login to xmtp.chat to try
