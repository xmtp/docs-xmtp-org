...
- chain_rpc_1 = Ethereum Mainnet
- chain_rpc_10 = Optimism
- chain_rpc_137 = Polygon (formerly Matic)
- chain_rpc_324 = zkSync Era
- chain_rpc_480 = World Chain
- chain_rpc_8453 = Base
- chain_rpc_42161 = Arbitrum One
- chain_rpc_59144 = Linea
