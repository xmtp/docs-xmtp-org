...
The passkey signer has the same 3 required properties as the EOA and SCW signers, but also requires a function that returns the hex-encoded 32-byte public key of the passkey.
