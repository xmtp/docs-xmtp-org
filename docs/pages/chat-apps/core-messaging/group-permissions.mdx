...
### Create a group with custom permissions using identities

You can also create a group using public identities instead of inbox IDs:

:::code-group

```kotlin [Kotlin]
// Create a group with custom permissions using public identities
...
### Add members by public identity

You can add members using their public identities instead of inbox IDs. This method returns a `GroupMembershipResult` with details about the operation.

:::code-group

```kotlin [Kotlin]
// Add members using public identities
...
### Remove members by public identity

:::code-group

```kotlin [Kotlin]
// Remove members using public identities
