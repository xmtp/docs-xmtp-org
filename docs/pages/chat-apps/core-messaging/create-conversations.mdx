...
## Leave a group chat (React Native SDK v5.1.0+)

Users can leave group chats they are currently members of. When a user leaves a group, they will no longer receive messages from that group and cannot send messages to it.
