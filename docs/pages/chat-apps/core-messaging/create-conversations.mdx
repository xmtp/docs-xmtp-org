...
### Create a group using public identities

Instead of using inbox IDs, you can create groups directly using public identities. This is useful when you have wallet addresses but haven't yet resolved them to inbox IDs.

:::code-group

```kotlin [Kotlin]
// Create a group using public identities instead of inbox IDs
...
### Create a DM using public identity

You can also create a DM directly using a public identity instead of an inbox ID:

:::code-group

```kotlin [Kotlin]
// Create or find a DM using a public identity
...
// Returns a DM by public identity
