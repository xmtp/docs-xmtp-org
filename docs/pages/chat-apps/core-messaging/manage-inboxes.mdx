...
:::warning[Node SDK only]
These methods are only available in the Node SDK, not in the Browser SDK.
:::
...
The custom signature flow differs slightly between Browser and Node SDKs:
