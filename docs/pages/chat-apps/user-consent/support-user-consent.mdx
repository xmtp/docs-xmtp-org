...
<div>
<img src="https://raw.githubusercontent.com/xmtp/docs-xmtp-org/refs/heads/main/docs/pages/img/you-might-know-tab.jpg" width="400" alt="Screenshot of a mobile chat app showing a 'You might know' tab with filtered conversation requests from contacts with onchain interaction history" />
</div>
