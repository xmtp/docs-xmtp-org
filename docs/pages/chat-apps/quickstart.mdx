...
```bash
xmtp conversations create-dm 0xf9244662f952d6ef83bd0719ddb5a27fbb2fe1bc
```
...
```bash
xmtp conversation messages <id> --sync
```

You should see your message and the agent's reply:

```
senderInboxId   content  sentAt
--------------  -------  -------------------
a1b2c3d4e5f6…   gm       2026-02-20 12:00:00
f6e5d4c3b2a1…   gm       2026-02-20 12:00:01
```
