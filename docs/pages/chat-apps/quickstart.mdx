import { QuickstartProvider, QuickstartStep, CopyableCode } from '../../components/QuickstartSteps';
...
<CopyableCode analyticsStep="1-vite-setup" code={`import { defineConfig } from "vite";
