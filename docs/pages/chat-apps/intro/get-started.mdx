...
- [Troubleshoot errors](/chat-apps/debug/error-codes).

- [Stress and burn-in test](/chat-apps/debug/debug-your-app#xmtp-debug) your chat app.

- [Enable file logging](/chat-apps/debug/debug-your-app#file-logging).

- [Capture network statistics](/chat-apps/debug/debug-your-app#network-statistics).
