...
const messages = await group.messages({
  ...
  excludeSenderInboxIds: ['inbox_id_1'], // Exclude senders
  sortBy: 'SENT_TIME', // Sort by sent time or 'INSERTED_TIME'
  insertedAfterNs: 1738620126404999936, // Filter by insertion time
  insertedBeforeNs: 1738620226404999936, // Filter by insertion time
});
