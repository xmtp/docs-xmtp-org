...
// List groups with new filtering options
const groups = await alix.conversations.listGroups(
  {}, // options
  10, // limit
  ['allowed'], // consentStates
  undefined, // createdAfterNs
  Date.now() * 1000000 - 7 * 24 * 60 * 60 * 1000000000, // createdBeforeNs (past 7 days)
  undefined, // lastActivityAfterNs
  undefined, // lastActivityBeforeNs
  'created_at' // orderBy
);

// List DMs with filtering
const dms = await alix.conversations.listDms(
  {},
  20,
  ['allowed'],
  undefined,
