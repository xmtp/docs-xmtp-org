...
await alix.conversations.list({}, undefined, ['allowed']);
...
// Advanced filtering with time-based parameters
await alix.conversations.list(
  {}, // conversation options
  10, // limit
  ['allowed'], // consent states
  Date.now() * 1_000_000 - 7 * 24 * 60 * 60 * 1_000_000_000, // createdAfterNs (last 7 days)
  undefined, // createdBeforeNs
  Date.now() * 1_000_000 - 24 * 60 * 60 * 1_000_000_000, // lastActivityAfterNs (last 24 hours)
