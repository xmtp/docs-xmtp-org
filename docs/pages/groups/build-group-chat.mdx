...
Group chat supports push notifications. To learn more, see the [Notifications with XMTP](/notifications/build-notifications) section.
...
Take these steps to display group chats associated with the current client.
...
Take these steps to stream group chats.
...
To learn more, see [Local Database and Syncing](/groups/build-group-chat#local-database-and-syncing). 
