...
XMTP works with externally owned accounts (EOAs) and Smart Contract Wallets ([EIP-191](https://eips.ethereum.org/EIPS/eip-191), [EIP-1271](https://eips.ethereum.org/EIPS/eip-1271), [EIP-6492](https://eips.ethereum.org/EIPS/eip-6492)) on Ethereum and Ethereum side-chains and L2s.
