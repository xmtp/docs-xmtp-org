...
You can [revoke specific installations](/agents/core-messaging/manage-inboxes#revoke-an-installation) and even [revoke an installation you can't log into](/agents/core-messaging/manage-inboxes#revoke-an-installation-when-you-dont-have-access-to-the-app-installation).

To learn more, see [Manage XMTP inboxes, identities, and installations](/agents/core-messaging/manage-inboxes).
