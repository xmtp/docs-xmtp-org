...
- `Client.create`, see [Create an XMTP client](#TODO).

- `conversations.sync`, see [Sync new conversations](#TODO).

- `conversations.streamAllMessages`, see [Stream all group chat and DM messages and preferences](#TODO).

- `conversations.getConversationById`, see [Conversation helper methods](#TODO).

- `conversation.send`, see [Send messages](#TODO).
