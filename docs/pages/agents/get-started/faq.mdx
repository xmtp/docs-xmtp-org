...
### Which web3 libraries does the XMTP Agent SDK require?

The XMTP Agent SDK provides simplified abstractions for common use cases. For custom integrations, you can use [ethers](https://ethers.org/) or another web3 library capable of supplying an [ethers Signer](https://docs.ethers.io/v5/api/signer/), such as [wagmi](https://wagmi.sh/).
