...
- **XMTP builds in the open**
  ...
  - Explore the open [XMTP GitHub org](https://github.com/xmtp), which contains code for LibXMTP, XMTP SDKs (including the Agent SDK), and xmtpd, node software powering the XMTP testnet.
