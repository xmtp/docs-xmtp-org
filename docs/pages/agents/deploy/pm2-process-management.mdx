...
XMTP sdks have a lot of guardrails in place to prevent crashes. However, long running processes are hard to guarantee 100% uptime, for that we recommend using a process manager like [PM2](https://pm2.io/) to ensure proper restart behavior and logging.
