...
- `disappearing_message_settings`: Settings for disappearing messages in the group chat. To learn more about disappearing messages, see [Support disappearing messages](/agents/core-messaging/send-messages#send-a-disappearing-message)
