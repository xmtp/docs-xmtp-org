...
:::tip[Quickstart]
To learn more, see the [Attachment example](https://github.com/ephemeraHQ/xmtp-agent-examples/tree/main/examples/xmtp-attachments) in the xmtp-agents-examples repo.
:::
...
const xmtp = await Agent.create(signer, {
  env: 'dev',
