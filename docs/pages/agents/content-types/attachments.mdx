...
Unless a very specific use case we recommend using the [remote attachment content type](/agents/content-types/attachments#support-remote-attachments-of-any-size) instead since many attachments are larger than 1MB in a messaging app.
:::
