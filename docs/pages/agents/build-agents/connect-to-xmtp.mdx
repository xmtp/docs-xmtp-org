...
:::tip
Using Claude Code or another AI coding assistant? The XMTP Agent SDK has [Claude Code skills](/agents/get-started/build-with-llms#claude-code-skills) that can scaffold, deploy, and troubleshoot your agent project directly from your terminal.
:::
...
- **Railway**: Configure a volume and set `XMTP_DB_DIRECTORY` to the mount path (e.g., `/data`).
