...
Group chats can have metadata, like names, descriptions, and images. Metadata can help users more easily identify their group chats. You can set group chat metadata when [creating a group chat](/agents/build-agents/create-conversations), and get and update metadata using these methods.
