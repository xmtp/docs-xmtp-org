...
:::tip
The XMTP node-sdk and agent-sdk have only been tested on Ubuntu distributions. While other Debian-based distributions may work, compatibility is not guaranteed.
:::
