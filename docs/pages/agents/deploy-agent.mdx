...
The XMTP Node SDK and Agent SDK have been tested on Ubuntu distributions only. While other Debian-based distributions may work, compatibility is not guaranteed.
