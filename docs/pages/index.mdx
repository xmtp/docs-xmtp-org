...
<div className="custom-homepage-cta-container">
  ...
  <a
    href="/chat-apps/intro/quickstart"
...
<CustomHomePage.SectionTitle id="build-for-chat-clients">

Build for chat apps

</CustomHomePage.SectionTitle>

<p>Build agents and mini apps that run in:</p>

<CustomHomePage.SDKGrid centered>

<CustomHomePage.SDKTile
  href="https://docs.base.org/base-app/agents/chat-agents"
  lightSrc="/Base_square_blue.svg"
  darkSrc="/Base_square_blue.svg"
  alt="Base App"
  name="Base App"
  isExternal
/>
...
<CustomHomePage.SDKTile
  ...
  lightSrc="/World-Logomark-Black-RGB.svg"
  darkSrc="/World-Logomark-White-RGB.svg"
  alt="World App"
  name="World App"
  isExternal
/>
