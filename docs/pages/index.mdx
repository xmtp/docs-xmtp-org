...
Build with <img src="/x-mark-blue.png" alt="XMTP" className="xmtp-logo-light-mode" /><img src="/x-mark-blue.png" alt="XMTP" className="xmtp-logo-dark-mode" /> XMTP
...
<div className="custom-homepage-cta-container">
  <a href="/agents/intro/intro" className="custom-homepage-cta-button custom-homepage-cta-button--primary">Build an agent</a>
  <a href="/inboxes/intro/intro" className="custom-homepage-cta-button custom-homepage-cta-button--secondary">Build an inbox</a>
</div>
...
<CustomHomePage.SDKTile 
  ...
  lightSrc="/nodejsStackedLight.svg"
  darkSrc="/nodejsStackedDark.svg"
  alt="Node.js"
  name="Node SDK"
/>
