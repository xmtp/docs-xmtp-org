...
<CustomHomePage.Root>
  ...
  <CustomHomePage.TileGrid>
    ...
    />
    <CustomHomePage.Tile
      href="/inboxes/create-client"
      title="Build inboxes - V3 Alpha"
      description="Build standalone inbox apps for mobile and web using XMTP V3 for DMs and groups"
      icon="📥"
    />
    <CustomHomePage.Tile
      href="/get-started/developer-quickstart"
      title="Build inboxes - V2/V3"
      description="Build standalone inbox apps for mobile and web using a hybrid of XMTP V2 for DMs and V3 for groups"
      icon="📥"
    />
    <CustomHomePage.Tile
