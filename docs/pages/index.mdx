...
<div className="custom-homepage-cta-container">
  <a href="/agents/build-an-agent" className="custom-homepage-cta-button custom-homepage-cta-button--primary">Build an agent</a>
  <a href="/sdks/browser" className="custom-homepage-cta-button custom-homepage-cta-button--secondary">Build an inbox</a>
</div>
