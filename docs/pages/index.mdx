...
<CustomHomePage.Tile
  title={<><img src="/plug-lightmode.svg" alt="" className="plug-icon-light-mode" /><img src="/plug-darkmode.svg" alt="" className="plug-icon-dark-mode" /> Join the XMTP Switchboard</>}
  description="Connect with other devs building with XMTP—online and soon in co-working spaces around the world"
