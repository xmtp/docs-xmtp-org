---
description: "Learn about filtering valid contact requests from spam in apps built with XMTP."
---

# Filter valid contact requests from spam in apps built with XMTP
...
Implement [user consent preferences](/consent/user-consent) in your app to allow only conversations with approved contacts to display in a user's main inbox. A user's main inbox remains spam-free because they are in control of which conversations are allowed to display there.

<div>
<img src="https://raw.githubusercontent.com/xmtp/docs-xmtp-org/refs/heads/main/docs/pages/img/block-accept.jpg" width="400" />
</div>
...
<div>
<img src="https://raw.githubusercontent.com/xmtp/docs-xmtp-org/refs/heads/main/docs/pages/img/requests-link.jpg" width="400" />
</div>

These unknown contact requests might include:
