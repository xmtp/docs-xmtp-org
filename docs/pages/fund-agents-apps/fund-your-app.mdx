...
You can use the payer wallet (and only the payer wallet) to [withdraw](#step-6-withdraw-and-claim-funds) USDC from your messaging fee allowance.
...
1. Use the wallet you want to use to fund the payer wallet to connect to the XMTP Funding Portal: [https://fund.xmtp.org/](http://fund.xmtp.org/).
...
Once you use your wallet to allocate funds to the payer wallet, only the payer wallet can [withdraw](#step-6-withdraw-funds) USDC from the messaging fee allowance.
